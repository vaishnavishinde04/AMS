    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                <div class="count-indicator">
                  <img class="img-xs rounded-circle " src="assets/images/faces/<%=user%>.jpg" alt="profile">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/Attendance/attendance.jsp">
              <span class="menu-icon">
			 ...
			 <li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/Workdays/workdaysmain.jsp">
              <span class="menu-icon">
			...
			<li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/Holidays/holidaysmaintenance.jsp">
              <span class="menu-icon">
			...
			<li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/newuser.html">
              <span class="menu-icon">
			...
			<li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/Attendance/Generate_Attendance.jsp">
              <span class="menu-icon">
                <i class="mdi mdi-contacts"></i>
              </span>
              <span class="menu-title">Generate Attendance</span>
            </a>
            </li>
			
			<li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/Attendance/viewAttendaceForm.jsp">
              <span class="menu-icon">
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="assets/images/faces/<%=user%>.jpg" alt="">
        ...
        <div class="main-panel">
                  ...
                  <div class="card-body">
                    ...
                    <div class="row">
                      <div class="col-8 col-sm-12 col-xl-8 my-auto">
                        ...
                        <h6 class="text-muted font-weight-normal"> AMS</h6>
                      </div>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                        ...
                        <tbody>
                          <tr>
                            <td>
                              <img src="assets/images/faces/vaishnavi.jpg" alt="image" />
                              <span class="pl-2">Vaishnavi Shinde</span>
                            </td>
                            <td> TE </td>
                            <td> T721504353 </td>
                            <td> 20121005 </td>
						  ...
						  <tr>
                            <td>
                              <img src="assets/images/faces/aditi.jpeg" alt="image" />
                              <span class="pl-2">Aditi Umare</span>
                            </td>
                            <td> TE</td>
                            <td> 72150343K </td>
                            <td> 2132233 </td>
          ...
          <footer class="footer">
            <div class="d-sm-flex justify-content-center justify-content-sm-between">
              ...
              <span class="float-none float-sm-right d-block mt-1 mt-sm-0 text-center"> Attendance Management System</span>
            </div>
          </footer>
          <!-- partial -->
        </div>
