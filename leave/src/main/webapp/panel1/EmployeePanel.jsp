    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/Attendance/emp_attendance.jsp">
              <span class="menu-icon">
            ...
            <li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/Attendance/leave.html">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
            ...
            <li class="nav-item menu-items">
            <a class="nav-link" href="http://localhost:8081/leave/Attendance/leaveStatus.jsp">
              <span class="menu-icon">
                <i class="mdi mdi-laptop"></i>
              </span>
                    ...
                    <div class="table-responsive">
                      <table class="table">
                       ...
                       <tbody>
						  ...
						  <tr>
                            <td>
                              <img src="assets/images/faces/aditi.jpg" alt="image" />
